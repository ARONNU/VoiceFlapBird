...
namespace VoiceCont_FlapBird
{
    public partial class Form1 : Form
    {
        ...
        void gameoverappear()
        {
            ...
            else if (bad2.Bounds.IntersectsWith(bird.Bounds))
            {
                timer1.Enabled = false;
                timer2.Enabled = false;
                gameoverlogo.Visible = true;
            ...
            else if (floor1.Bounds.IntersectsWith(bird.Bounds))
            {
                timer1.Enabled = false;
                timer2.Enabled = false;
                gameoverlogo.Visible = true;
            ...
            else if (floor2.Bounds.IntersectsWith(bird.Bounds))
            {
                timer1.Enabled = false;
                timer2.Enabled = false;
                gameoverlogo.Visible = true;
            ...
            else if (floor3.Bounds.IntersectsWith(bird.Bounds))
            {
                timer1.Enabled = false;
                timer2.Enabled = false;
                gameoverlogo.Visible = true;
